...
import { CreateContextRequest } from "@/types/context"

interface ContextCreateFormProps {
  onSave: (contextData: CreateContextRequest) => Promise<any>
  onCancel: () => void
  isLoading?: boolean
}
...
export function ContextCreateForm({
  ...
  const handleInputChange = (field: keyof CreateContextRequest, value: string) => {
  ...
  return (
    <div className="bg-white rounded-lg border p-6">
      <div className="flex items-center justify-between mb-6">
        <h3 className="text-lg font-semibold text-gray-900">Create New Context</h3>
        <button
          onClick={onCancel}
          disabled={isLoading}
